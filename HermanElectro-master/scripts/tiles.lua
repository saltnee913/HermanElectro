...
P.button = P.tile:new{powered = false, dirSend = {1,1,1,1}, dirAccept = {1,1,1,1}, canBePowered = true, name = "button", pressed = false, sprite = love.graphics.newImage('button.png'), poweredButton = love.graphics.newImage('buttonPressed.png')}
tiles[1] = P.tile
