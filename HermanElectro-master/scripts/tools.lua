...
P.ghostStep = P.superTool:new{name = "ghostStep", desription ="Tap a tile from a distance.", image = love.graphics.newImage('Graphics/ghoststep.png'), baseRange = 6, quality = 1}
