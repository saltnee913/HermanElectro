...
P.superWireCutters = P.wireCutters:new{name = "Incisors", description = "Something to chew on", -- Anything more ... you know
...
--The World Wide Web
P.laptop = P.superTool:new{name = "Laptop", description = "Search", image = 'Graphics/laptop.png', baseRange = 0, quality = 1}
